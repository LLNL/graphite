...
class E3NN_SelfAttention(torch.nn.Module):
    ...
    * https://docs.e3nn.org/en/stable/guide/transformer.html
    ...
    Args:
        ...
        irreps_q (e3nn.o3.Irreps or str): Irreps of query features
        irreps_k (e3nn.o3.Irreps or str): Irreps of key features
        irreps_v (e3nn.o3.Irreps or str): Irreps of value features (also the irreps of output node features).
        irreps_sh (e3nn.o3.Irreps or str): Irreps of edge spherical harmonics.
